      ...
      <Box sx={{ position: 'relative', marginTop: '100px' }}>
        <div>
          ...
          <p>
            ...
            Project Area from child labour, ii) Preparing children withdrawn
            from work for mainstream education alongwith vocational training;
            iii) Ensuring convergence of services provided by different
            government departments/agencies for the benefit of child and their
            family; B. To contribute to the withdrawal of all adolescent workers
            from Hazardous Occupations / Processes and their skilling and
            integration in appropriate occupations through i) Identification and
            withdrawal of all adolescent workers from hazardous occupations /
            processes, ii) Facilitating vocational training opportunities for
            such adolescents through existing scheme of skill developments; C.
            Raising awareness amongst stakeholders and target communities, and
            ...
            occupations/processes'; and D. Creation of a Child Labour
            Monitoring, Tracking and Reporting System. The scheme focuses on: i)
            All child workers below the age of 14 years in the identified target
            area. ii) Adolescent workers below the age of 18 years in the target
            area engaged in hazardous occupations / processes iii) Families of
